...
//CODE HERE
let jsNinja = () => "I am a Javascipt ninja";
console.log(jsNinja())
...
let nameGreeting = nameCheck("Mike")
...
console.log(bestMovie("The Godfather"))
...
changeToUpperCase(sampleString)
...
function emailCheck(email) {
  ...
  if (email.includes('@')) {
    return 'Email verifed'
  } else {
    return 'must provide a valid email address'
  }
}
console.log(emailCheck('boni.deg@gmail.com'))
